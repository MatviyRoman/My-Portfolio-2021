...
const socials = [
        social('GitHub', 'icon github', 'https://github.com/MatviyRoman'),
        social('Linkendin', 'icon linkedin', 'http://linkedin.com/in/MatviyRoman'),
        social('Facebook', 'icon facebook', 'https://www.facebook.com/romas6ka'),
        social('Skype', 'icon skype', 'skype:live:romas6ka'),
        social('Viber', 'icon viber', 'viber:chat?number=+380938800822'),
        // social(
        //  'YouTube',
        //  'icon youtube',
        //  'https://www.youtube.com/channel/UCZ1W8CdO3fDnvsobEqkbv6w'),
        social('E-mail', 'icon envelope', '#contact')
    ]
    /* Social End */
    /* Skills Begin */
