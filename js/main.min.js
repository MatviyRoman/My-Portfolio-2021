...
const abouts = [
    aboutMe(
        ...
        "Vue.js, React, NEXT, NUXT, Node.js, TypeScript, PHP, MySQL, Laravel",
        "Vue.js, React, NEXT, NUXT, Node.js, TypeScript, React, PHP, MySQL, AJAX",
...
const frontEnds = [
    frontEnd("HTML5", "95"),
    frontEnd("CSS3", "85"),
    frontEnd("CSS Flexbox", "85"),
    frontEnd("CSS Grid", "50"),
    frontEnd("SASS/ SCSS", "87"),
...
const languages = [
    language("English", "55", "Pre-intermediate"),
...
const contacts = [
    ...
    contact("fab fa-telegram", "Telegram", "https://t.me/RomanMatviy"),
];
/* Contacts End */
/* Links Begin */
const link = (name, url) => ({
...
const menus = [
    ...
    menu("Resume CV", "https://roman.matviy.pp.ua"),
